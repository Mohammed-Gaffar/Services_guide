...
namespace PlayApp.Helpers2
{
    public class FormsAuthHelper
    {
        ...
        public static Task RedirectToLogin(RedirectContext<CookieAuthenticationOptions> context, string baseUrl, string ProjectName)
        {
            var request = context.Request;
            ...
            context.RedirectUri = baseUrl + context.Options.LoginPath + "?" + context.Options.ReturnUrlParameter + "=/" + ProjectName + "/";
